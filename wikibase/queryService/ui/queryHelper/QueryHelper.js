...
wikibase.queryService.ui.queryHelper.QueryHelper = ( function( $, wikibase, _ ) {
	...
	SELF.prototype._getHtml = function() {
		...
		$html.on( 'DOMSubtreeModified', '.toolbar', _.debounce( function(){ self._createTagCloud(); } , 500 ) );
		//$html.on( 'DOMSubtreeModified', '.select2', _.debounce( function(){ self._createTagCloud(); } , 500 ) );
	...
	SELF.prototype._createTagCloudShow = function() {
		var self = this,
		$tagCloud = $( '<div data-entity="property" data-type="tagCloud" class="tagCloud" style="width:45vw; height:200px;">' );
...
//			update();
	...
	SELF.prototype._createTagCloudFilter = function() {
		var self = this,
			$tagCloud = $( '<div data-entity="item" data-type="tagCloud" class="tagCloud" style="width:45vw; height:200px;">' );
